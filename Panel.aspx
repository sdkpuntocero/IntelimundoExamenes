                ...
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-menu">
                        <ul>
                            ...
                            <asp:UpdatePanel ID="upVideoClases_li" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <li class="sidebar-dropdown">
                                        <asp:LinkButton CssClass="buttonClass" ID="lkbVideoClases_li" runat="server" OnClick="lkbVideoClases_li_Click">
                                            <i class="far fa-play-circle"></i>
                                            <span>Video Clases</span>
                                        </asp:LinkButton>
                                    </li>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                            ...
                            <ContentTemplate>
                                <div class="row">
                                    <div class="col-12" id="divTema" runat="server" visible="false">
                                        <div class="jumbotron">
                                            <img runat="server" id="imgTema" src="" class="img-fluid img-thumbnail" alt="..." />
                                        <%--    <hr class="my-4">--%>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-md-10">
                                                                    ...
                                                                    <p class="card-text">¿Estás listo para probar lo que aprendiste?</p>
                                                                    <p class="card-text"><small class="text-muted">* <strong>Primero</strong> debes de realizar una síntesis de lo que repasaste con un minio de: </p>
                                                                    </small>
                                                            <p class="card-text"><small class="text-muted"><a>* <strong>¡Recuerda!</strong> Sólo puedes realizar una vez el cuestionario de cada tema, así que toma <strong>apuntes</strong>,  te servirán para repaso.</a></small></p>
                                                                    <br />
                                                                </div>
                                                                <div class="col-md-2">
                                            ...
                                            <asp:UpdatePanel ID="upVideoClases" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <div class="card" runat="server" id="cardVideoClases" visible="true">
                                                        <div class="card-body">
                                                            <h5 runat="server" id="H2" title="uno">
                                                                <asp:Label ID="Label1" CssClass="modal-title" runat="server" Text="Video Clases"></asp:Label>
                                                            </h5>
                                                            <div class="row">
                                                                <div class="col-md-12" runat="server">
                                                                    <div class="embed-responsive embed-responsive-16by9">
                                                                        <iframe class="embed-responsive-item" src="Material/VideoClases.mp4"></iframe>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
