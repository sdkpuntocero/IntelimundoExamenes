<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acceso.aspx.cs" Inherits="IntelimundoExamenes.Acceso" %>
...
<body>
    <div class="login-form">
        ...
        <form runat="server">
            ...
            <div class="form-group">
                <input type="password" class="form-control" runat="server" id="i_clave" required="required" autocomplete="off" placeholder="Contraseña" tabindex="2" />
                <br />
            </div>

            <div class="form-group text-right">
                <asp:LinkButton ID="lkb_registro_inicial" runat="server" CssClass="text-info" TabIndex="4" Visible="false" Text="Registro Inicial">
                </asp:LinkButton>
            </div>
            ...
            <div class="text-right small">
                ...
                <asp:UpdatePanel ID="upControlUsuarios" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:LinkButton CssClass="buttonClass" ID="lkbControlUsuarios" runat="server">
